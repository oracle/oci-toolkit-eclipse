...
public class ChangeAdminPasswordADBWizard  extends Wizard implements INewWizard {

    private ChangeAdminPasswordADBWizardPage page;
    private ISelection selection;
    private AutonomousDatabaseSummary instance;

    public ChangeAdminPasswordADBWizard(final AutonomousDatabaseSummary instance) {
        super();
    ...
    public void addPages() {
        page = new ChangeAdminPasswordADBWizardPage(selection, instance);
        addPage(page);
    }
    ...
    public boolean performFinish() {
        ...
        IRunnableWithProgress op = new IRunnableWithProgress() {
			...
			public void run(IProgressMonitor monitor) throws InvocationTargetException {
				ADBInstanceClient.getInstance().changeAdminPassword(instance, adminPassword);
				monitor.done();
			}
        };
        try {
            ...
            MessageDialog.openError(getShell(), "Failed to change Admin password for database : "+instance.getDbName(), realException.getMessage());
            return false;
        }
