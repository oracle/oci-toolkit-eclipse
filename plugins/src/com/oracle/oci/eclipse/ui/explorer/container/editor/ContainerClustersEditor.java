...
public class ContainerClustersEditor extends BaseEditor implements PropertyChangeListener {

    public final static String ID = ContainerClustersEditor.class.getName();
    public final static String TITLE = "Container Clusters (OKE)";
    ContainerClustersEditor classReference = this;
    ContainerClustersTable table;

    @Override
    public void createPartControl(Composite parent) {
        ScrolledForm form = super.initForm(parent);
        table = new ContainerClustersTable(form.getBody(), SWT.None);
